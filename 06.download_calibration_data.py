...
with ecotaxa_py_client.ApiClient(config) as client:
    ...
    fields = 'txo.id,txo.display_name,img.file_name,obj.latitude,obj.longitude,obj.classif_qual,obj.orig_id,fre.cnn_score'
...
df = df[['obj.orig_id', 'objid', 'img.file_name', 'txo.display_name', 'obj.classif_qual', 'acq_id', 'fre.cnn_score']]
# Rename columns
...
pq.write_table(
  ...
  where=os.path.join(data_dir, 'rhizaria_calibration_data.parquet'),
